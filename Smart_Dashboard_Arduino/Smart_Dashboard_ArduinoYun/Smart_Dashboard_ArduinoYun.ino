...
//String location = "/getstatus.php?id=3 HTTP/1.0";
//String locationSetFree = "/setstatus.php?id=3&busy=0 HTTP/1.0";
//String locationSetBusy = "/setstatus.php?id=3&busy=1 HTTP/1.0";
//String locationSetNoBreak = "/setstatus.php?id=3&needsbreak=0 HTTP/1.0";
//String locationSetNeedBreak = "/setstatus.php?id=3&needsbreak=1 HTTP/1.0";
...
//    Serial.println("other");
  ...
  if (buttonStateAvail == HIGH) {     
    client.get("209.68.4.163/~arthurn/yolo/setstatus.php?id=3&busy=0");
    client.read();
  ...
  if (buttonStateAvail == HIGH) {     
    client.get("209.68.4.163/~arthurn/yolo/setstatus.php?id=3&needsbreak=0");
    client.read();
  ...
  if (buttonStateBusy == HIGH) {     
    client.get("209.68.4.163/~arthurn/yolo/setstatus.php?id=3&busy=1");
    client.read();
...
//    Serial.println("fired");   
    client.get("209.68.4.163/~arthurn/yolo/setstatus.php?id=3&needsbreak=1");
    client.read();
    Serial.println("Need Break Set");
    client.flush();
    
    client.get("209.68.4.163/~arthurn/yolo/sms.php?id=3");
    client.read();
...
String connectAndRead(){
  ...
  client.get("209.68.4.163/~arthurn/yolo/getstatus.php?id=3");
